 ...
 * {@link ItemTouchHelper.Callback#onMove(RecyclerView, RecyclerView.ViewHolder, RecyclerView.ViewHolder)} and / or
 * {@link ItemTouchHelper.Callback#onSwiped(RecyclerView.ViewHolder, int)}.
 * <p>
 ...
 * overriding {@link ItemTouchHelper.Callback#onChildDraw(Canvas, RecyclerView, RecyclerView.ViewHolder, float, float, int,
 * boolean)}
 * or {@link ItemTouchHelper.Callback#onChildDrawOver(Canvas, RecyclerView, RecyclerView.ViewHolder, float, float, int,
 * boolean)}.
 * <p/>
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
     ...
     * {@link ItemTouchHelper.Callback#getAbsoluteMovementFlags(RecyclerView, RecyclerView.ViewHolder)} for the current
     * action state.
     */
    int mSelectedFlags;
    ...
    private final RecyclerView.OnItemTouchListener mOnItemTouchListener
        ...
        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent event) {
            ...
            if (action == MotionEvent.ACTION_DOWN) {
                ...
                if (index >= 0) {
                    checkSelectForSwipe(recyclerView,action, event, index);
                }
            }
        ...
        public void onTouchEvent(RecyclerView recyclerView, MotionEvent event) {
            ...
            if (activePointerIndex >= 0) {
                checkSelectForSwipe(recyclerView,action, event, activePointerIndex);
            }
    ...
    boolean checkSelectForSwipe(RecyclerView recyclerView,int action, MotionEvent motionEvent, int pointerIndex) {
        ...
        int size = recyclerView.getAdapter().getItemCount()-1;
     ...
     * {@link ItemTouchHelper.Callback#onMove(RecyclerView, RecyclerView.ViewHolder, RecyclerView.ViewHolder)
